 ...
 */
final class Version20221017145041 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE etudiant ADD classroom_id INT DEFAULT NULL, CHANGE nsc nsc INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE etudiant DROP classroom_id, CHANGE nsc nsc INT AUTO_INCREMENT NOT NULL');
    }
}
